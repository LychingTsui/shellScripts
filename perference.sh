getPersonalPerferenceAndMovieFeature=com.qiguo.tv.movie.featCollection.GetPersonalPerferenceAndMovieFeature
...
output="/user/tvapk/cuiliqing/out1"
jarPath="/home/tvapk/run_sh/cuiliqing/"
jarName="grecommends.jar"
...
$hadoop fs -get ${hdfs}personalLikesKey  ${localPath}
personalLikeTotal=`cat ${localPath}personalLikesKey | wc -l`
...
$hadoop jar ${jarPath}${jarName} $getPersonalPerferenceAndMovieFeature  $userLikes $output ${hdfs}movieLikesCache $likesTagsStartId $personalLikesIdStart $cutrate
