...
#$hadoop fs -cp /user/tvapk/cuiliqing/personalLikes $input
$hadoop fs -rm -r $output
input2=/user/tvapk/peichao/TV/movieper/20160420/usermovieG
$hadoop jar ${shPath}$jar PersonalRecommend.PersonalSort2Model  $input $input2 $output $cache $flag $group 
rm $dataPth$grpflag$date"allGuidPred.txt"
#grpflag 组别标志码
$hadoop fs -getmerge ${output}/part-* $dataPth$grpflag$date"allGuidPred.txt"
